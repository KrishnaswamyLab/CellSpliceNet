...
if __name__ == "__main__":
    cmd_parser = argparse.ArgumentParser(description="ESM2 comparison baseline.")
    ...
    model = ESM2(use_pretrained=cmd_args.use_pretrained).to(device)
    ...
    log(
        f"[ESM2] Training begins (use_pretrained={cmd_args.use_pretrained}).",
