...
if __name__ == "__main__":
    ...
    log_file = os.path.join(ROOT_DIR, 'comparisons', 'results', 'Pangolin', f'log_seed-{cmd_args.random_seed}.txt')
    model_save_path = os.path.join(ROOT_DIR, 'comparisons', 'results', 'Pangolin', f'model_seed-{cmd_args.random_seed}.pt')
    os.makedirs(os.path.dirname(model_save_path), exist_ok=True)

    log(f'[Pangolin] Training begins.', filepath=log_file)
