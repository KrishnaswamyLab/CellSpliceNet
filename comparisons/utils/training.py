...
def add_comparison_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--n-samples", default=1000000, type=int, help="Training sample budget (total examples seen; batch-size independent).")
    parser.add_argument("--eval-every", default=50000, type=int, help="Run capped validation every N training samples.")
